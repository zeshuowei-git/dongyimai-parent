					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							...
							<span class="jqzoom">
								...
								<img jqimg="${ItemImageList[0].url}" src="${ItemImageList[0].url}" width="400px" height="400px" />
					...
					<div class="clearfix choose">
						...
						<#list specificationList as specification>
							...
							<#list specification.attributeValue as item>
								<dd ng-click="selectSpecification('${specification.attributeName}','${item}')"><a href="javascript:;" class="{{isSelected('${specification.attributeName}','${item}')?'selected':''}}">${item}
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="cart.html" target="_blank" ng-click="addCart()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
